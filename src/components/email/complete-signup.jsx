...
export default function CompleteSignupEmail({ verificationURL }) {
  return (
    <Html lang="fa" dir="rtl">
      ...
      <Preview>با تنظیم رمز عبور ثبت نام خود را تکمیل کنید</Preview>
      <Tailwind>
          ...
          <Container className="max-w-96 py-11 mx-auto px-6 text-black">
            <main>
              <Text className="text-lg">
                <strong>ثبت نام خود را در لگد تکمیل کنید</strong>
              </Text>
              <Text>
              ...
              <Text>
                در صورتی که شما درخواست ثبت‌نام نکرده اید، این پیام را نادیده
